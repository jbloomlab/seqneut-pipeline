...
- Minor bug fix to resolve issue with specifying serum_replicates to manual drops, similar issue to above. Addresses [this issue](https://github.com/jbloomlab/neutcurve/issues/49).
