...
@app.cell
def __(context, io, mo, pd, sys, yaml):
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Apply any manually specified data drops:""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Average counts per barcode in each well""")
    return
...
def _(
    ...
    return neut_standard_fracs, neut_standard_fracs_chart
...
def _(
    ...
    return neut_standard_counts, neut_standard_counts_chart
...
def _(
    ...
    return no_serum_counts, no_serum_counts_chart, strain_selection_dropdown
...
def _(alt, no_serum_counts_1, pd, plate):
    ...
    return median_no_serum_ratio, median_no_serum_ratio_chart
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Check how many dilutions we have per barcode / serum-replicate:""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Plot all the curves that passed QC:""")
    return
